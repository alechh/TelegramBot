...
def start_message(message):
    bot.send_message(message.chat.id, '''Приветствую тебя. Я бот, который будет мотивировать тебя и давать полезные советы, чтобы помочь тебе справляться со всеми трудностями и невзгодами на своем жизненном пути.
Что я умею:
1)Напиши мне дату, время и что напомнить и я буду напоминать тебе о твоих запланированных делах.
2)Я буду давать мотивационные советы.
3)Я буду задавать тебе наставляющие вопросы, благодаря им ты сможешь добиваться своих целей гораздо быстрее и с меньшими усилиями.
4)Я буду отправлять тебе разные цитаты великих мыслителей.''')
